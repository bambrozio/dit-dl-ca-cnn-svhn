...
def main():
    ...
    # JPG from internet
    #result1 = svhn.test("data/svhn/manualTest/data/svhn/full/test/246x0w.jpg") #123
    #print(result1)

    # i might also test with a PNG

    # Images from full dataset, preprocessed
    result2 = svhn.test("data/svhn/manualTest/data/svhn/full/test/19.png") #60
    print(result2)
    result3 = svhn.test("data/svhn/manualTest/data/svhn/full/test/16.png") #14
    print(result3)

    # Image from full dataset, non-preprocessed
    result4 = svhn.test("data/svhn/full/test/323.png") #2
    print(result4)
